...
% tss_pred_loaded = ncread('predicted_tss.nc', 'TSS_pred');
% lon_loaded = ncread('predicted_tss.nc', 'longitude');
% lat_loaded = ncread('predicted_tss.nc', 'latitude');
% 
% % Bigger bounding box
...
% 
% % Step 1: Load the saved model
% load('rf_model_best.mat', 'rf_model_best', 'wavelengths');
% 
% % Model wavelengths (403 to 718 nm, 117 bands)
% model_wl = wavelengths;
% 
...
% legend('show');
% grid on;
% % saveas(gcf, 'sample_rrs_spectra_validated.png');
...
% Add colorbar and set logarithmic ticks
h = colorbar;
h.Label.String = 'TSS (mg L^{-1})';
h.Label.FontSize = 12;
