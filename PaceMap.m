...
%%
figure;
 m_proj('lambert','lat',[30 34],'lon',[-78. -82.]);
...
set(c,'ytick',([0.0001 0.001 0.005 0.01 0.05]),'yticklabel',["<0.2","0.5", "1", "2", "5"],'tickdir','out')
set(get(c,'xlabel'),'string','Rrs [Sr^-1]', 'FontSize', 12,'FontName','Leelawadee')
