...
% Ensure saved PDF matches screen size
set(gcf, 'PaperPositionMode', 'auto'); 
sgtitle('Comparison for stations 10 to 16 (excluding 13)', 'FontSize', 16, 'FontWeight', 'bold');  % Set figure title

% Loop through stations 10 to 16, excluding station 13
station_indices = [10:12, 14:16];  % Exclude station 13
...
filename = fullfile('/Users/masud/OneDriveUGA/CruiseRVSavannah/Comparison_plots/', "All_Good_Pace" + ""  + ".png");
