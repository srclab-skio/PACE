...
data_table_sim = readtable('Simul_Rrs_Nechad_et_al_2015_PACE_Bands_only.csv', 'VariableNamingRule', 'preserve');
% data_table_sim = readtable('Subset_global_GLORIA_LAB_close_tss5.csv', 'VariableNamingRule', 'preserve');
% data_table_sim = readtable('Filtered_Subset_global_GLORIA_LAB_close_tss5.csv', 'VariableNamingRule', 'preserve');
...
data_table_insitu = readtable('Subset_SAB_RRS_GLORIA_LAB_tss10.csv', 'VariableNamingRule', 'preserve');
tss_insitu = data_table_insitu.TSS;  % TSS values (mg/L)
rrs_data_insitu = table2array(data_table_insitu(:, 21:end));  % Rrs spectra
num_samples_insitu = size(rrs_data_insitu, 1);
...
%     writetable(close_table, 'Subset_SAB_RRS_GLORIA_LAB_tss10.csv');
%     fprintf('Saved close samples with all variables and predicted TSS to Subset_global_GLORIA_LAB_close_tss.csv\n');
% else
%     fprintf('No samples with TSS difference <20 mg/L found.\n');
% end
